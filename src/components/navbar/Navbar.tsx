...
export default function Example() {
              ...
              {usuario.id !== 0 && (
                ...
                {usuario.id !== 0 && (
                  ...
                  >
                    ...
                    <Menu.Item>
                        {({ active }) => (
                          <div className={classNames(active ? 'bg-gray-100' : '', 'flex items-center justify-center px-4 py-2')}>
  ...
  {({ active }) => (
    <a
      ...
      className={classNames(
        active ? 'bg-gray-100' : '',
        'block px-4 py-2 text-sm text-gray-700 border-t border-b border-gray-200' // Adicionando bordas superior e inferior
      )}
    >
      Your Profile
    </a>
                      ...
                      <Menu.Item>
                        {({ active }) => (
                          <a
                            href="#"
                            className={classNames(active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700 border-t border-b')}
                          >
                            Settings
                          </a>
                        )}
                      ...
                      <Menu.Item>
                        {({ active }) => (
                          <a
                            href="#"
                            className={classNames(active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700 border-t border-bg')}
                          >
                            Sign out
                          </a>
                        )}
